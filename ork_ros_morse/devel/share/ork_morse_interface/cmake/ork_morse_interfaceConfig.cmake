...
if(NOT "/home/arthur/MORSE_DIR/riddle_pr2/ork_ros_morse/devel/include " STREQUAL " ")
  set(ork_morse_interface_INCLUDE_DIRS "")
  set(_include_dirs "/home/arthur/MORSE_DIR/riddle_pr2/ork_ros_morse/devel/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ork_morse_interface' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/arthur/MORSE_DIR/riddle_pr2/ork_ros_morse/src/ork_morse_interface/${idir}'.  Ask the maintainer 'arthur <arthur@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/arthur/MORSE_DIR/riddle_pr2/ork_ros_morse/devel/lib;/home/arthur/MORSE_DIR/riddle_pr2/ork_ros_morse/devel/lib;/home/arthur/RF_RIDDLE_WS/devel/lib;/home/arthur/GUI_RIDDLE_WS/GUI_Stage_RF_OR/workspace/devel/lib;/home/arthur/ORK_RIDDLE_WS/devel/lib;/opt/ros/indigo/lib)
